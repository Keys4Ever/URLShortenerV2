...
export const deleteUrl = async (shortUrl) => {
    const response = await fetch(`${API_BASE_URL}/url/${shortUrl}`, {
        method: 'DELETE',
    });
    return await response.json();
};
...
export const getUserUrls = async (userId) => {
    const response = await fetch(`${API_BASE_URL}/url/${userId}`, {
        method: 'GET',
    });
    return await response.json();
};
...
export const getAllFromUrl = async (shortUrl) => {
    const response = await fetch(`${API_BASE_URL}/url/details/${shortUrl}`, {
        method: 'GET',
    });
    return await response.json();
};
